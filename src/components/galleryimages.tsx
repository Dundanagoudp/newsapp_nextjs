...
//         <Image
//           src={imageService.getImageUrl(selectedImage._id)}
//           alt={selectedImage.originalName}
//           fill
//           className="object-contain"
//           priority
//           unoptimized // Important for dynamic images from your backend
//         />
//       </div>
...
//           >
//             <Image
//               src={imageService.getImageUrl(img._id)}
...
//         </p>
//         <p className="text-gray-500">Size: {(selectedImage.size / 1024).toFixed(2)} KB</p>
//         <p className="text-gray-500">Type: {selectedImage.mimeType}</p>
//       </div>
//     </div>
//   );
// };
